...
import { EditAnnouncementModal } from "@/app/admin/announcements/_components/EditAnnouncementModal";
...
const getAudienceLabel = (targetRole: string, course: { title: string } | null) => {
  const labels: Record<string, string> = {
    ...
    AllTeachers: "All Teachers/Admin",
    AllUsers: "All Users",
...
export function AnnouncementsTable({ selectedCourse, sortBy }: AnnouncementsTableProps) {
  ...
  const handleDelete = async (id: string) => {
    try {
      ...
      setDeleteId(null);
      // Refetch announcements instead of router.refresh()
      fetchAnnouncements();
    } catch (error) {
